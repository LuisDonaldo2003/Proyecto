                        ...
                        <div class="input-group">
                            ...
                            <select class="form-select form-select-lg form-control" name="activity_id">
                                ...
                                @foreach ($activities as $activity)
                                    <option value="{{ $activity->id }}" @if(old('activity_id') == $activity->id) selected @endif>{{ $activity->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        @error('activity_id')
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-select form-select-lg form-control" name="instructor_id">
                                ...
                                @foreach ($instructors as $instructor)
                                    <option value="{{ $instructor->id }}" @if(old('instructor_id') == $instructor->id) selected @endif>{{ $instructor->name }} {{ $instructor->last_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        @error('instructor_id')
